INSERT INTO STATUSES (status_id, name) VALUES (1, 'Доступен');
INSERT INTO STATUSES (status_id, name) VALUES (2, 'Недоступен');
INSERT INTO STATUSES (status_id, name) VALUES (3, 'Сбои в работе');
